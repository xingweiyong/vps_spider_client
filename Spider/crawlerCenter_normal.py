                    ...
                    for each_page in range(1, int(max_page) + 1):
                        ...
                        if len(product_urls) > 0:
                            for each_product_url in product_urls:
                                ...
                                worker_parse_detail('https:' + each_product_url, shop_brand, dl,mutex)
                        else:
...
# spider_tmall_shop_ultra
import spider_tmall_shop_ultra
crawler_tmall_shop_ultra = spider_tmall_shop_ultra.crawler_tmall_shop_ultra